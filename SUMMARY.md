...
* [五、Python 语言和语法](language-and-grammar/README.md)
  * [为什么 CPython 是用 C 语言而不是用Python语言来实现](language-and-grammar/why-cpython-is-written-in-c.md)
  * [Python 语言定义](language-and-grammar/python-language-specification.md)
